...
/* move:
*	Select the move to place the B stack element in the correct position in stack A.
...
*	they may be rotated individually before pushing the top B element to the top of stack A.
*/
